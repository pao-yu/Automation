...
Sub UnifyPivotData()
    ...
    Dim wb As Workbook                                                     ' Define object variables and set objects
    Dim ws As Worksheet
    Dim pt As PivotTable
    Set wb = ActiveWorkbook

    Dim answer As Integer                                                  ' Define input variables and variable types
    ...
    If answer = vbYes Then
        ...
        sourceTableName = InputBox(Prompt:="Enter datasource name (case-sensitive).", _
                                    Title:="Data Location")
